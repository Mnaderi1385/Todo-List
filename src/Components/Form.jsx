...
const Form = () => {
    ...
    return (
        <form className="flex flex-col sm:flex-row w-full" onSubmit={handleAddTask}>
            ...
            <button className="w-full sm:w-auto flex justify-center items-center text-sm duration-300 transition-all mt-4 border border-slate-700 select-none px-4 py-[8px] rounded-md sm:rounded-r-md sm:rounded-l-none text-center text-white bg-slate-800 hover:bg-slate-700 mr-2 focus:border-indigo-800" type="submit">
